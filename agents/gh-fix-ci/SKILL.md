...
- `python agents/gh-fix-ci/scripts/inspect_pr_checks.py --repo "." --pr "<number-or-url>"`
...
Usage examples:
- `python agents/gh-fix-ci/scripts/inspect_pr_checks.py --repo "." --pr "123"`
- `python agents/gh-fix-ci/scripts/inspect_pr_checks.py --repo "." --pr "https://github.com/org/repo/pull/123" --json`
- `python agents/gh-fix-ci/scripts/inspect_pr_checks.py --repo "." --max-lines 200 --context 40`
